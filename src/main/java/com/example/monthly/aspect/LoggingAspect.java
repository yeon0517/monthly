package com.example.monthly.aspect;
...
public class LoggingAspect {
    @Before("@annotation(com.example.monthly.aspect.annotation.LoggingPointcut)")
    ...
    @Around("@annotation(com.example.monthly.aspect.annotation.LoggingPointcut)")
